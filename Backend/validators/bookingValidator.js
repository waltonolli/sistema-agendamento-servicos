...
const createBookingSchema = Joi.object({
  ...
  providerId: Joi.number().integer().positive().required().messages({
    'number.base': 'Prestador de serviço é obrigatório',
    'number.integer': 'Prestador de serviço deve ser um identificador válido',
    'number.positive': 'Prestador de serviço deve ser um identificador válido',
    'any.required': 'Prestador de serviço é obrigatório'
  }),
...
const updateBookingSchema = Joi.object({
  ...
  providerId: Joi.number().integer().positive().optional().messages({
    'number.base': 'Prestador de serviço deve ser um identificador válido',
    'number.integer': 'Prestador de serviço deve ser um identificador válido',
    'number.positive': 'Prestador de serviço deve ser um identificador válido'
  }),
  date: Joi.string().isoDate().required().messages({
